    ...
    <div onClick={onClickOutside} className="video-modal">
      <div className="container">
        <div className="video-wrapper">
          <Image src="https://img.youtube.com/vi/HR1BaFO0R1I/maxresdefault.jpg" alt="" layout="fill" />
    ...
    <Fragment>
          ...
          <div className="row justify-content-center">
            <div className="col-xxl-7 col-xl-8 col-lg-9 col-md-12">
              <div className="video-content text-center">
                <a onClick={handleClick}><i className="fas 
      ...
      {isModalOpen && (
        <Modal onClickOutside={handleClick}>
          <iframe src="https://www.youtube.com/embed/HR1BaFO0R1I?autoplay=1" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
        </Modal>
      )}
